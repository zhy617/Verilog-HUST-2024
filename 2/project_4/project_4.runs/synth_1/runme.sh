...
HD_PWD='D:/CS_Learning/class/Verilog/2/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _7Seg_display.tcl
