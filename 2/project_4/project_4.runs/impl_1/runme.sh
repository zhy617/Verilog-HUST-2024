...
HD_PWD='D:/CS_Learning/class/Verilog/2/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source _7Seg_display.tcl -notrace
