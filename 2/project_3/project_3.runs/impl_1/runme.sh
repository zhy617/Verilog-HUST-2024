...
HD_PWD='D:/CS_Learning/class/Verilog/2/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_Driver_Display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source _7Seg_Driver_Display.tcl -notrace
