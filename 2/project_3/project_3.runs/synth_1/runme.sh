...
HD_PWD='D:/CS_Learning/class/Verilog/2/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log _7Seg_Driver_Display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source _7Seg_Driver_Display.tcl
